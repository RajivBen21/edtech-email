...
<head>
    ...
    <title>Export Preview - Retrieval</title>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Export Preview - Account/Password Retrieval<span class="record-count"><?php echo $record_count; ?> records</span></h3>
            </div>
            ...
            <div class="warning-box" style="background: #f0fdf4; border-color: #22c55e;">
                ...
                <ul style="color: #166534; margin: 10px 0 0 20px;">
                    ...
                    <li>Request Type checkboxes (Account/Password)</li>
                    <li>Table with <?php echo min(10, count($grouped_records[array_key_first($grouped_records)])); ?> record(s)</li>
                    <li>Signature fields (Prepared by, Recommended by, Received by, Approved by)</li>
                    <li>Request monitoring section with Email Address and Password columns</li>
                    <li>Request Status / Remarks section</li>
                </ul>
            </div>
