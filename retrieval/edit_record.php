...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($college_department) || empty($last_name) || empty($first_name)) {
        ...
        try {
            $stmt = $pdo->prepare("
                UPDATE retrieval_records SET
                    college_department = ?, request_type = ?, student_employee_id = ?,
                    last_name = ?, first_name = ?, middle_name = ?,
                    email_address = ?, password = ?, record_date = ?, remarks = ?,
...
<head>
    ...
    <title>Edit Retrieval Record - LDCU EdTech System</title>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                <h3 class="card-title">Edit Retrieval Record #<?php echo $record_id; ?></h3>
            ...
            <form method="POST" action="">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="request_type" id="request_type" class="form-control" required>
                            <option value="Account" <?php echo ($record['request_type'] ?? 'Account') == 'Account' ? 'selected' : ''; ?>>Account</option>
                            <option value="Password" <?php echo $record['request_type'] == 'Password' ? 'selected' : ''; ?>>Password</option>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="student_employee_id" id="student_employee_id" class="form-control"
                           value="<?php echo htmlspecialchars($record['student_employee_id'] ?? ''); ?>">
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="email" name="email_address" id="email_address" class="form-control"
                               value="<?php echo htmlspecialchars($record['email_address'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
